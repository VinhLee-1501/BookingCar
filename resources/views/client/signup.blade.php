        ...
        <div class="container bg-light p-md-5" style="width: 600px;">
            ...
            <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ request()->routeIs('user.signin') ? 'active' : '' }}" id="tab-login"
                       data-mdb-pill-init href="{{ route('user.signin') }}"
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ request()->routeIs('user.signup') ? 'active' : '' }}" id="tab-register"
                       data-mdb-pill-init href="{{ route('user.signup') }}"
                ...
                <div class="" id="" role="" aria-labelledby="">
                    <form>
                        ...
                        <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                class="btn btn-primary btn-block mb-3">Đăng ký
                        </button>
                    </form>
                </div>
            </div>
