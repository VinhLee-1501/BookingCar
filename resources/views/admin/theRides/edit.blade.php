                    ...
                    <div class="col-lg-12 row mt-2">
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="exampleInputPassword1"
                                   value="{{$Therides->price}}" name="price">
                        </div>
                        {{--                        <div class="col-lg-6">--}}
