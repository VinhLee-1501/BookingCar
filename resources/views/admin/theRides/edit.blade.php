...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="card">
            @if(session('update'))
                <h5 class="alert alert-success" >{{session('update')}}
                </h5>
            @endif
            <div class="card-body">
                <form action="{{ route('theride.update',$Therides->id)}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="Text" class="form-control" id="exampleInputEmail1" aria-describedby="name"value="{{$Therides->name}}" name="name">
                        {{--                                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>--}}
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Thời gian</label>
                        <input type="datetime-local" class="form-control" id="exampleInputPassword1"value="{{$Therides->time_to_go}}" name="time_to_go">
                    </div>
                    <div class="col-lg-12 row">
                        <div class="col-lg-6">
                            <label for="exampleInputPassword1" class="form-label">Thời gian dự kiến đi</label>
                            <input type="datetime-local" class="form-control"value="{{$Therides->estimated_arrival_time}}"  id="exampleInputPassword1"
                                   name="estimated_departure_time">
                        </div>
                        <div class="col-lg-6">
                            <label for="exampleInputPassword1" class="form-label">Thời gian dự kiến đến</label>
                            <input type="datetime-local" class="form-control"value="{{$Therides->estimated_departure_time}}" id="exampleInputPassword1"
                    ...
                    <div class="col-lg-12 row mt-2">
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="exampleInputPassword1"value="{{$Therides->price}}" name="price">
                        </div>
                        {{--                        <div class="col-lg-6">--}}
