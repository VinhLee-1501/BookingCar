            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                    <form method="POST" action="{{ route('siginStore') }}">
                        ...
                        <!-- Password -->
                        <div data-mdb-input-init class="form-outline mb-4">
                            <x-input-label for="password" :value="__('Mật khẩu')" class="form-label " for="loginPassword" />
                        ...
                        <div class="row d-flex">
                            <div class="col-md-6 mt-2">
                                <x-primary-button data-mdb-button-init data-mdb-ripple-init class=" btn btn-primary p-2">
                                    {{ __('Đăng nhập') }}
                                </x-primary-button>
                            </div>
                            <div class="col-md-6">
